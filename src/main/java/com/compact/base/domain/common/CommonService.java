...
public class CommonService {
	...
	public ApiResponse getFileM(String sttdt, String enddt, String eqpId, String partId, 
			String stepSeq, String lotId, String fileName, String lotType, String pgmName) {
